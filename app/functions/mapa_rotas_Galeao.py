...
df_val_de_cans = carregar_dataset.df[carregar_dataset.df['Aeroporto.Origem'] == 'Aeroporto Internacional Do Rio De Janeiro/Galeao']
...
for _, row in df_grouped.iterrows():
    origem = 'Aeroporto Internacional Do Rio De Janeiro/Galeao'
